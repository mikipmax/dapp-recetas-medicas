...
const RegistroRecetas = () => {
    const {pacientes, recetaServicio, mostrarNotificacion} = useContext(AppContext);
                            ...
                            <form onSubmit={handleFormularioSubmit}>
                                ...
                                <Select
                                    ...
                                    options={pacientes.map(paciente => ({
                                        value: paciente,
                                        label: paciente.cedulaPaciente + " - " + paciente.nombresPaciente + " " + paciente.apellidosPaciente + " - " + paciente.edadPaciente + " años"
                                    }))}
                                />
